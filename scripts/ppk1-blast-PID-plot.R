...
locus_order <- c('2687453699_PEBOPBNB_00179',
...
blast_pid %>% ggplot(aes(x=ref1, y=ref2, fill=PID)) + geom_raster() + scale_fill_viridis() + theme(axis.text.x= element_text(angle=85, hjust=1))

write.csv(locus_order, "~/Desktop/locus_order.csv")
